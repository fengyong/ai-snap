...
我是个后端开发者。Java、Go、数据库、微服务、消息队列——这些是我的舒适区。GUI？那是二十年前的事了。
...
此后我一头扎进后端开发，再没碰过客户端。直到最近，我被 Qoder 的开发能力惊艳到了——它居然能直接写 macOS 原生应用？那个在脑子里躺了二十年的方案，突然又活了过来：也许我可以用它做一个真正好用的截图标注工具。

2026 年了，AI 元年。这个痒，可以挠一挠了。
